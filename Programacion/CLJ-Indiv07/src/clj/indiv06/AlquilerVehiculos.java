...
public class AlquilerVehiculos {
    ...
    public static void main(String[] args) throws IOException {
        ...
        leerDatos(clientes, vehiculos, alquileres);
        ...
        while (salir == false) {
            ...
            switch (opcion) {
                ...
                case 8:
                    ...
                    break;
                case 9:
                    guardarDatos(clientes, vehiculos, alquileres);
                    break;
                case 0:
    ...
    private static void guardarDatos(ArrayList<Cliente> clientes, ArrayList<Vehiculo> vehiculos, ArrayList<Alquiler> alquileres){
    ...
    private static void leerDatos(ArrayList<Cliente> clientes, ArrayList<Vehiculo> vehiculos, ArrayList<Alquiler> alquileres) throws IOException{
        String ruta = "C:\\Repos\\Programacion\\Programacion\\CLJ-Indiv07\\";
        String[] txt;
        String[] elemento;
